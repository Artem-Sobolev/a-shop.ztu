                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i> +38 093 112 75 51</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> temafury@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="mainmenu pull-left">
                                    ...
                                    <form id="search" method="post" action="/search" class="searchform">
